...
[WeeRT]
    ...
    [[loop_filters]]
        ...
        heatindex_temp = heatindex
        extra1_temp = extraTemp1
        extra2_temp = extraTemp2
        extra3_temp = extraTemp3
        leaf1_temp = leafTemp1
        leaf2_temp = leafTemp2
        soil1_temp = soilTemp1
        soil2_temp = soilTemp2
        soil3_temp = soilTemp3
        soil4_temp = soilTemp4
        in_temp_battery_status = inTempBatteryStatus
        out_temp_battery_status = outTempBatteryStatus
